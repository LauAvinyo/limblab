...
styles = {
    ...
    "channel_0": {"color": "#B0DB43"},
    "channel_1": {"color": "#db43b0"},
    "channel_2": {"color": "#43b0db"},
    "limb": {"alpha": 0.1, "color": "#FF7F11"},
    "reference": {"alpha": 1, "color": 1},
    "isosurfaces": {"alpha": 0.3, "alpha-unique": 0.8},
    "ui": {"primary": "#0d1b2a", "secondary": "#fb8f00"},
}
