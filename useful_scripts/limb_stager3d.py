import numpy as np
from vedo import settings, dataurl, fit_plane
...
msh = Mesh(dataurl+"290.vtk").c("blue8", 0.8)
txt = Text2D(pos="top-center", bg="yellow5", s=1.5)

plt = SplinePlotter(msh, title="3D Stager", N=2, sharecam=0, size=(2000,1000))
plt.verbose = False
